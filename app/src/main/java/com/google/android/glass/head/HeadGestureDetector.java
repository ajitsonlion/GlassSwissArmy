package com.google.android.glass.head;

/**
 * Created by ajit on 19.01.15.
 */
...
public class HeadGestureDetector {
    ...
    private   long STATE_TIMEOUT_NSEC = 1 * 1000 * 1000;
    private static final float MIN_MOVE_ANGULAR_VELOCITY = 0.50F;
    ...
    private int numberOfHeadShakes=0;
    private int maxNumberOfHeadShakes=2;
    ...
    public HeadGestureDetector(Context context,long timeout) {
        mSensorManager = (SensorManager) context.getSystemService(Context.SENSOR_SERVICE);
        mSensorEventListener = new HeadGestureSensorEventListener();
        STATE_TIMEOUT_NSEC=timeout;
    }
